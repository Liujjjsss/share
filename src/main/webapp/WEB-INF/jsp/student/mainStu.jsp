                 ...
                 <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           ...
                           <button class="btn btn-default" onclick="window.location.href='goAddStuPaper'">开始组卷<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           <p>查看试卷</p>
                           <h3 class="number">90</h3>
                           <button class="btn btn-default" onclick="window.location.href='goTeaPaperList'">点击查看<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           <p>金币充值</p>
                           <h3 class="number">90</h3>
                           <button class="btn btn-default" onclick="window.location.href='goRecharge'">点击充值<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           <p>系统推广</p>
                           <h3 class="number">90</h3>
                           <button class="btn btn-default" onclick="window.location.href=''">点击开始<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
