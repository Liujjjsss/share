												...
												<ul>
													<c:forEach items="${paper.option }" var="option" varStatus="status1">
														...
														<li class="option">
															...
															<input type="text" class="radioOrCheck am-form-field" name="answer${status.count }"
																	id="${status.count }_answer_1_option_${status1.count }"
																/>
														</li>
														</c:when>
														...
														<li class="option">
															...
															<textarea class="radioOrCheck am-form-field" rows="5" id="${status.count }_answer_1_option_${status1.count }" name="answer${status.count }"></textarea>
														</li>
														</c:otherwise>
														</c:choose>
													</c:forEach>
