...
function select() {
	...
	if (name == null) {
		window.location.href='doSubjectCheckList';
	} else {
		window.location.href='selectCheckList?name=' + name;
	}
}
</script>
</head>
<body>
	<div class="admin">
			...
			<div class="content">
				<div class="card-box">
					<h4 class="header-title m-t-0 m-b-30">科目审核列表</h4>
					<!-- Row start -->
					<div class="am-g">
					  ...
					  <!-- Row start -->
				       ...
				       <div class="am-u-sm-12">
				           <table class="am-table am-table-striped am-table-hover table-main">
				             <thead>
				             <tr>
				               <th class="table-check"><input type="checkbox" /></th><th class="table-id">#</th><th class="table-subject">科目名称</th><th class="table-porfession">专业</th><th class="table-set">操作</th>
				             </tr>
				             </thead>
				             <tbody id="news-lis">
				             ...
				             <tr class="news-item">
				               ...
				               <td>${status.count }</td>
				               <td><a href="getSubjectCheck?id=${subject.id }">${subject.subjectName }</a></td>
