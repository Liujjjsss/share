				...
				<!-- Row start -->
					<div class="am-u-sm-12">
						<div class="card-box">
							...
							<div class="am-g">
								<div class="am-u-md-6">
									<form action="updateUserInfo" method="post" class="am-form am-text-sm" id="am-form-update" onSubmit="return checkForm()">
										...
										<div class="am-form-group">
									   	...
									   	<div class="am-form-group">
									    	<div class="am-g">
									    		<label class="am-u-md-2 am-md-text-right" for="lv">学校</label>
											      <select id="lv" name="school">
