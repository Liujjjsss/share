                 ...
                 <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           ...
                           <button class="btn btn-default" onclick="window.location.href='doQuestionList'">点击查看<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           <p>查看科目</p>
                           <h3 class="number">90</h3>
                           <button class="btn btn-default" onclick="window.location.href='doSubjectList'">点击查看<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="content">
                       ...
                       <div class="title-content">
                           <p>审核科目</p>
                           <h3 class="number">90</h3>
                           <button class="btn btn-default" onclick="window.location.href='getNoSubject'">点击查看<span style="color:red;"></span></button>
                       </div>
                       </div>
                       <div class="clearfix"></div>
                    </div>
                 ...
                 <div class="col-md-8">
                   <div class="panel panel-default">
                      <div class="panel-heading">
                       充值审核<div class="caret"></div>
                       <a href="#" class="pull-right"><span class="glyphicon glyphicon-refresh"></span></a>
                      </div>  
                      <c:forEach items="${rechargeList }" var="recharge" varStatus="status" begin="0" end="4" step="1">   
                      <div class="panel-body">
                           ...
                           <div class="w55 pull-left">${recharge.username }</div>
                           <div class="w20 pull-left text-center">${recharge.sum }</div>
                          <div class="w10 pull-left text-center"><span class="text-green-main"></span></div>
                      </div>
                      </c:forEach>
                      <div class="panel-body text-center">
                          <a href="getNoRecharge" style="color:#5297d6;">查看全部</a>
                      </div>
                 ...
                 <div class="col-md-4">
                     <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                           ...
                           <div class="w55 pull-left"><a href="getNoSubjectById?id=${subject.id }">${subject.subjectName }</a></div>
                           <div class="w20 pull-left text-center">${subject.professionName }</div>
                          <div class="w10 pull-left text-center"><span class="text-green-main"></span></div>
                      </div>
                      </c:forEach>
                    </div>
