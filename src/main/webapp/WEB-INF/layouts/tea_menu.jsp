...
<head>
    ...
    <body>
		...
		<div class="tm_menu_item clearfix">
			...
			<ul>
				<li><a href="doAddQuestion">添加试题</a></li>
		...
		<div class="tm_menu_item clearfix">
			...
			<ul>
				<li><a href="goAddTeaPaper">智能组卷</a></li>
		...
		<div class="tm_menu_item clearfix">
			...
			<ul>
				<li><a href="doAddSubject">创建科目</a></li>
				<li><a href="doSubjectCheckList">审核科目</a></li>				
		...
		<div class="tm_menu_item clearfix">
			...
			<ul>
				...
				<li><a href="doUpdateUserInfo">修改信息</a></li>
				<li><a href="doUpdatePwd">修改密码</a></li>
			</ul>
		</div>

		<div class="tm_menu_item clearfix">
			<h2><a href="javascript:void(0);" onclick="tm_toggle_menu(this)" class="tmc_menu_learn">充值</a></h2>
			<ul>
				<li><a href="goRecharge">金币充值</a></li>
			</ul>
		</div>
			
		<div class="tm_menu_item clearfix">
			<h2><a href="javascript:void(0);" onclick="tm_toggle_menu(this)" class="tmc_menu_user">推广</a></h2>
			<ul>
				<li><a href="">系统推广</a></li>
			</ul>
		</div>
